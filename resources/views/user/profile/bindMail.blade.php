                ...
                <div data-v-6e2d35de="" id="content" class="content-scroll">
                    ...
                    <form method="post" action="{{ route('user.store-Mail') }}">
                        ...
                        <div data-v-1daeed5a="" data-v-6e2d35de="" class="container">
                            <div data-v-1daeed5a="" data-v-6e2d35de="" class="cname">@lang('Mailbox')</div>
                        ...
                        <div data-v-1daeed5a="" data-v-6e2d35de="" class="go">
                            <div data-v-d8bb9fe2="" data-v-1daeed5a="" data-v-6e2d35de="" style="height: 1.4rem;">
                                <div data-v-d8bb9fe2="" class="big_btn_box">
                                    <div data-v-d8bb9fe2="" class="btn_box"><button type="submit" data-v-d8bb9fe2="" class="btn on">@lang('Update')</button></div>
                                </div>
                            </div>
                        </div>
