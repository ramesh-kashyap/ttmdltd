                            ...
                            <div data-v-366decca="" data-v-6e2d35de="" class="item valMob">
                                ...
                                <div data-v-366decca="" data-v-6e2d35de="" class="it">
                                    ...
                                    <div data-v-366decca="" data-v-6e2d35de="" class="flex inp val">
                                        <div data-v-366decca="" data-v-6e2d35de="" class="ico"></div>
                                        <div data-v-366decca="" data-v-6e2d35de="" class="flex1"><input     id="passwordInput" data-v-366decca="" name="password" data-v-6e2d35de="" placeholder="Please enter your password" onkeyup="this.value=this.value.replace(/[ ]/g,'')" type="password"></div>
                                        <div class="yj" onclick="togglePassword()">
            <img 
                id="eyeIcon"
                src="{{ asset('') }}static/img/eye3.png" 
                alt="Toggle Password"
