...
<body
    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #000; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; width: 100% !important; height: 100%; line-height: 1.6em; background-color: #f6f6f6; margin: 0;"
    bgcolor="#f6f6f6">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                 ...
                                 <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                     <td class="content-block"
                                      style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                      valign="top">
                                  We are delighted to inform you that your account with {{sitename()}} has been successfully activated. Welcome to our community!
    ...
    font-weight: 600;"
                                            valign="top">
                                           Package Name :<span style="  color: #289721;"> {{ $view_message['plan'] }} -  {{ $view_message['amount'] }} USDT</span>.
    ...
    font-weight: 600;"
                                            valign="top">
                                           Account ID : <span style="  color: #289721;">  {{ $view_message['username'] }} </span>
    ...
    font-weight: 600;"
                                            valign="top">
                                           Activation Date :  <span style="  color: #289721;"> {{ $view_message['date'] }} </span>
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                  <td class="content-block"
                                      ...
                                      valign="top">
                                      <br>
                                    Please ensure that you keep your login credentials secure and do not share them with anyone. If you have any questions or encounter any issues, feel free to reach out to our customer support team at info@etriton.co.        
                                  </td>
                              </tr> 
