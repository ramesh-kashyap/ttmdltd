                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            <b>{{ $view_message['ip'] }}</b>
                                            using
                                            <b>{{ $view_message['browser'] }}</b>
                                            on
                                            <b>
                                                {{ $view_message['operating_system'] }}
