    ...
    "56d7": function(e, o, i) {
        ...
        var a = i("2b0e"),
            ...
            r = {
                ...
                watch: {
                    $route(e, o) {
                        "" != this.$route.meta.title && (this.lang = this.$store.state.lang, document.title = this.$t(this.$route.meta.title) || "Lume-X");
                        let i = this;
        ...
        p["a"].beforeEach((e, o, i) => {
            document.title = e.meta.title || "Lume-X", i()
        });
        const so = new a["a"]({
            router: p["a"],
            i18n: ro,
