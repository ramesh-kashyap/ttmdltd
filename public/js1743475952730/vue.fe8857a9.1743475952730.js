    ...
    ["vue"], {
        ...
        "2b0e": function(e, t, n) {
            ...
            (function(e) {
                        ...
                        function e(e, t, n) {
                            if (void 0 === t && (t = !1), void 0 === n && (n = !1), this.value = e, this.shallow = t, this.mock = n, this.dep = n ? De : new Te, this.vmCount = 0, K(e, "__ob__", this), i(e)) {
                                ...
                                for (r = 0; r < s.length; r++) {
                                    o = s[r];
                                    Fe(e, o, Ie, void 0, t, n)
                                }
                            }
                        }
                        return e.prototype.observeArray = function(e) {
                            for (var t = 0, n = e.length; t < n; t++) Ne(e[t], !1, this.mock)
                        }, e
                    }();
                        ...
                        return Object.defineProperty(e, t, {
                            ...
                            set: function(t) {
                                ...
                                if (V(r, t)) {
                                    ...
                                    p = a ? t && t.__ob__ : Ne(t, !1, o), l.notify()
                                }
                            }
                        }), l
                    }
                ...
                function Re(e, t, n) {
                    if (!We(e)) {
                        var r = e.__ob__;
                        return i(e) && v(t) ? (e.length = Math.max(e.length, t), e.splice(t, 1, n), r && !r.shallow && r.mock && Ne(n, !1, !0), n) : t in e && !(t in Object.prototype) ? (e[t] = n, n) : e._isVue || r && r.vmCount ? n : r ? (Fe(r.value, t, n, void 0, r.shallow, r.mock), r.dep.notify(), n) : (e[t] = n, n)
                    }
                }
                ...
                function pt(e) {
                    return Tr(this.$options, "filters", e, !0) || F
                }
                ...
                function jt(e) {
                    ...
                    var a = n && n.data;
                    Fe(e, "$attrs", a && a.attrs || r, null, !0), Fe(e, "$listeners", t._parentListeners || r, null, !0)
                }
                var Nt = null;
                ...
                function Ft(e) {
                    Et(e.prototype), e.prototype.$nextTick = function(e) {
                        ...
                        var a, o = me,
                            s = Nt;
                        try {
                            ge(e), Nt = e, a = n.call(e._renderProxy, e.$createElement)
                        } catch (Zo) {
                ...
                function Bn() {
                    Hn = Dn.length = jn.length = 0, Nn = {}, Fn = Rn = !1
                }
                var Vn = 0,
                    Gn = Date.now;
                if (ee && !ne) {
                ...
                function Yn() {
                    var e, t;
                    for (Vn = Gn(), Rn = !0, Dn.sort(Xn), Hn = 0; Hn < Dn.length; Hn++) e = Dn[Hn], e.before && e.before(), t = e.id, Nn[t] = null, e.run();
                    var n = jn.slice(),
                        r = Dn.slice();
                ...
                function Qn(e) {
                    var t = e.id;
                    if (null == Nn[t] && (e !== Te.target || !e.noRecurse)) {
                        if (Nn[t] = !0, Rn) {
                            var n = Dn.length - 1;
                ...
                function Ar(e) {
                    ...
                    t.computed && Fr(e, t.computed), t.watch && t.watch !== le && Gr(e, t.watch)
                }
                ...
                function zr(e, t) {
                    ...
                    var o = function(a) {
                        i.push(a);
                        var o = Sr(a, t, n, e);
                        Fe(r, a, o, void 0, !0), a in e || Ir(e, "_props", a)
                    };
                    for (var s in t) o(s);
                    ze(!0)
                }
                ...
                function Fr(e, t) {
                    ...
                    for (var i in t) {
                        var a = t[i],
                            o = u(a) ? a : a.get;
                        0, r || (n[i] = new bn(e, o || j, j, Nr)), i in e || Rr(e, i, a)
                    }
                }
                ...
                var Ni = w("text,number,password,search,email,tel,url");
                ...
                function Ha(e, t) {
                    ...
                    if (t) {
                        var i = e;
                        while (i.componentInstance) i = i.componentInstance._vnode, i && i.data && (n = Fa(i.data)) && z(r, n)
                    }(n = Fa(e.data)) && z(r, n);
                    var a = e;
                    while (a = a.parent) a.data && (n = Fa(a.data)) && z(r, n);
                    return r
                }
                var Ba, Va = /^--/,
                    Ga = /\s*!important$/,
                        ...
                        if (!$ || x || "" === x) {
                            ...
                            var j = !1 !== i && !re,
                                ...
                                F = n._enterCb = B((function() {
                                    j && (po(n, P), po(n, O)), F.cancelled ? (j && po(n, M), z && z(n)) : A && A(n), n._enterCb = null
                                }));
                            e.data.show || rt(e, "insert", (function() {
                                ...
                                po(n, M), F.cancelled || (uo(n, P), N || (wo(D) ? setTimeout(F, D) : fo(n, s, F)))
                            }))), e.data.show && (t && t(), I && I(n, F)), j || N || F()
                        }
                    }
                }
                ...
                var ko = {
                    inserted: function(e, t, n, r) {
                        ...
                        })) : $o(e, t, n.context), e._vOptions = [].map.call(e.options, Po)) : ("textarea" === n.tag || Ni(e.type)) && (e._vModifiers = t.modifiers, t.modifiers.lazy || (e.addEventListener("compositionstart", Lo), e.addEventListener("compositionend", Io), e.addEventListener("change", Io), re && (e.vmodel = !0)))
                    },
                ...
                function Fo(e) {
                    ...
                    return t && t.Ctor.options.abstract ? Fo(Vt(t.children)) : e
                }
                ...
                Jr.config.mustUseProp = vi, Jr.config.isReservedTag = Ai, Jr.config.isReservedAttr = fi, Jr.config.getTagNamespace = zi, Jr.config.isUnknownElement = ji, z(Jr.options.directives, jo), z(Jr.options.components, Jo), Jr.prototype.__patch__ = ee ? So : j, Jr.prototype.$mount = function(e, t) {
                    return e = e && ee ? Fi(e) : void 0, On(this, e, t)
            ...
            (function(t, n) {
                            ...
                            if ("none" !== M.css("display")) {
                                if ("auto" === n.slidesPerView) {
                                    ...
                                    if (z && (M[0].style.transform = "none"), D && (M[0].style.webkitTransform = "none"), n.roundLengths) C = e.isHorizontal() ? M.outerWidth(!0) : M.outerHeight(!0);
                                        ...
                                        C = B && "border-box" === B && !W.isIE ? j + R + H : j + N + F + R + H
                                    } else {
                ...
                function Re() {
                    var t = this,
                        ...
                        i = t.el,
                        a = t.wrapperEl;
                    t.onTouchStart = ze.bind(t), t.onTouchMove = De.bind(t), t.onTouchEnd = je.bind(t), t.onClick = Fe.bind(t);
                    ...
                    (n.preventClicks || n.preventClicksPropagation) && o.addEventListener("click", t.onClick, !0), t.on(Ae.ios || Ae.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Ne, !0)
                }
                ...
                function He() {
                    ...
                    (n.preventClicks || n.preventClicksPropagation) && o.removeEventListener("click", t.onClick, !0), t.off(Ae.ios || Ae.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Ne)
                }
                var Be = {
                    attachEvents: Re,
                    detachEvents: He
                ...
                var vt = {
                    ...
                    Ut = [it, at, ot, st, ct, dt, ft, mt, yt, wt, xt, Et, St, $t, Ot, Lt, At, Dt, Nt, Rt, Bt, Gt, Xt, qt];
        ...
        "8c4f": function(e, t, n) {
            ...
            function H(e, t) {
                ...
                return function(t, r) {
                    for (var i = "", a = t || {}, o = r || {}, s = o.pretty ? F : encodeURIComponent, l = 0; l < e.length; l++) {
                        var c = e[l];
                        if ("string" !== typeof c) {
                            var u, d = a[c.name];
                            if (null == d) {
            ...
            et.prototype.listen = function(e) {
                ...
                if (b(e, i) && o === s && e.matched[o] === i.matched[s]) return this.ensureURL(), e.hash && Ce(this.router, i, e, !1), a(Fe(i, e));
                var l = nt(this.current.matched, e.matched),
                    ...
                    f = function(t, n) {
                        ...
                        try {
                            t(e, i, (function(t) {
                                !1 === t ? (r.ensureURL(!0), a(He(i, e))) : We(t) ? (r.ensureURL(!0), a(t)) : "string" === typeof t || "object" === typeof t && ("string" === typeof t.path || "string" === typeof t.name) ? (a(Ne(i, e)), "object" === typeof t && t.replace ? r.replace(t) : r.push(t)) : n(t)
                            }))
                        } catch (o) {
                            a(o)
                        }
        ...
        da19: function(e, t, n) {
            ...
            function i(e, t, n) {
                return r(e.x + n.x) === r(2 * t.x) && r(e.y + n.y) === r(2 * t.y)
            }
            ...
            function s(e, t, n) {
                var r = t.minX,
                    ...
                    l = n.min;
                e = e.map((function(e) {
                    return "number" === typeof e ? e : e.value
                }));
                var c = Math.min.apply(Math, e.concat([l])) - .001,
                    u = (a - r) / (e.length - 1),
                    d = (o - i) / (Math.max.apply(Math, e.concat([s])) + .001 - c);
                return e.map((function(t, n) {
                    return {
                        x: n * u + r,
                        y: o - (t - c) * d + 1e-5 * +(n === e.length - 1) - 1e-5 * +(0 === n)
                    }
                }))
            }
            ...
            function l(e, t) {
                var n = e.shift();
                return "M" + n.x + " " + n.y + e.map((function(r, s) {
                    var l = e[s + 1],
                        c = e[s - 1] || n,
                        u = l && i(l, r, c);
                    if (!l || u) return "L" + r.x + " " + r.y;
                    var d = Math.min(a(c, r), a(l, r)),
                        p = d / 2 < t,
                        f = p ? d / 2 : t,
                        h = o(c, r, f),
                        v = o(l, r, f);
                    return "L" + h.x + " " + h.y + "S" + r.x + " " + r.y + " " + v.x + " " + v.y
                })).join("")
            }
            var c = {
                ...
                u = {
                    ...
                    render: function(e) {
                        var t = this,
                            n = t.gradient,
                            r = t.gradientDirection,
                            i = t.id,
                            a = n.length - 1 || 1,
                            o = n.slice().reverse().map((function(t, n) {
                                return e("stop", {
                                    attrs: {
                                        offset: n / a,
                                        "stop-color": t
                    ...
                    watch: {
                        data: {
                            ...
                            handler: function(e) {
                                var t = this;
                                this.$nextTick((function() {
                                    if (!t.$isServer && t.$refs.path && t.autoDraw) {
                                        var e = t.$refs.path.$el,
                                            n = e.getTotalLength();
                                        e.style.transition = "none", e.style.strokeDasharray = n + " " + n, e.style.strokeDashoffset = Math.abs(n - (t.lastLength || 0)), e.getBoundingClientRect(), e.style.transition = "stroke-dashoffset " + t.autoDrawDuration + "ms " + t.autoDrawEasing, e.style.strokeDashoffset = 0, t.lastLength = n
                                    }
                                }))
                            }
                        }
                    ...
                    render: function(e) {
                        if (this.data && !(this.data.length < 2)) {
                            var t = this,
                                ...
                                l = this.$props;
                            return l.boundary = s, l.id = "vue-trend-" + this._uid, e("svg", {
                                attrs: {
                                    width: n || "100%",
                                    height: r || "25%",
                                    viewBox: "0 0 " + a + " " + o
            ...
            "undefined" !== typeof window && window.Vue && window.Vue.use(d), t["a"] = d
        }
    }
]);